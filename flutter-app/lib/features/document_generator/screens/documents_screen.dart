...
class _DocumentsScreenState extends State<DocumentsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => DocumentGeneratorProvider(
        currentUser: user,
      ),
      child: Consumer<DocumentGeneratorProvider>(
              ...
              children: [
                ...
                Expanded(
                  child: TabBarView(
                    ...
                    children: [
                      _buildNewRequestTab(context, provider, appTheme),
                      _buildMyDocumentsTab(context, provider, appTheme),
                      _buildSharedDocumentsTab(context, provider, appTheme),
                    ],
                  ),
                ),
              ],
