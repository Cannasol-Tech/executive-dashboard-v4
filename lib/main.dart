...
import 'features/auth/models/user_model.dart'; // Added import for UserModel
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        // Add UserModel provider that depends on AuthService
        ProxyProvider<AuthService, UserModel>(
          update: (_, authService, __) => 
              UserModel.fromFirebaseUser(authService.currentUser),
        ),
        // Add DocumentGeneratorProvider with dependency on UserModel
        ProxyProvider<UserModel, DocumentGeneratorProvider>(
          update: (_, userModel, __) => DocumentGeneratorProvider(currentUser: userModel),
        ),
      ],
