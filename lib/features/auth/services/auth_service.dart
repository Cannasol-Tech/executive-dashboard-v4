...
class AuthService implements AuthServiceInterface {
  // Firebase Auth instance - using the named app instance
  ...
  AuthService._internal() {
    try {
      ...
      print('AuthService using named Firebase app: ${app.name}');
    } catch (e) {
      print('Neither default nor named Firebase app is available: $e');
      throw Exception('Failed to initialize Firebase Authentication');
    }
  }
