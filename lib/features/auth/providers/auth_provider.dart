...
class AuthProvider with ChangeNotifier {
  ...
  Future<void> _loadUserData(UserModel user) async {
    ...
    _errorMessage = null;
    notifyListeners();
    print("DEBUG -> _loadUserData called with user: ${user.uid}");
    ...
    print("DEBUG -> User photo URL: ${user.photoUrl}");
    print("DEBUG -> User role: ${user.role}");
    print("DEBUG -> User permissions: ${user.permissions}");
    print("DEBUG -> User last login: ${user.lastLogin}");
