        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              ...
              children: [
                _buildNewRequestTab(context, documentProvider),
                _buildMyDocumentsTab(context, documentProvider),
                _buildSharedDocumentsTab(context, documentProvider),
              ],
          ),
          ),
        ],
  ...
  Widget _buildNewRequestTab(BuildContext context,
    ...
    return ListView(
      ...
      children: [
        ...
        _buildRecentRequestsSection(context, provider),
      ],
    );
  }
